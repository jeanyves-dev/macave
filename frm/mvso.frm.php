...
if ($_GET["remvso"] <> 0)
{
	...
	echo '<tr><td>note : </td><td><input type="text" name="nomvso" maxlength="50" value="'.$mvso->nomvso().'" /></td></tr>';
}
else
{
	echo '<tr><td>Date : </td><td><input type="date" name="damvso" maxlength="50" /></td></tr>';
	echo '<tr><td>note : </td><td><input type="text" name="nomvso" maxlength="50" /></td></tr>';
}
